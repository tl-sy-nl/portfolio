  ...
  return (
    ...
    >
      ...
      <FadeIn>
        ...
        <p>But I could not unsee something else — something the research surfaced but could not resolve within its scope. What a four-year-old could practise at home depended on a chain of material conditions that started well before the platform: the apartment&apos;s square footage, the parent&apos;s work schedule, the parent&apos;s confidence in guiding movement with their own body. In concept testing, we found that parents&apos; guidance capacity varied enormously — some could only sit and watch the screen alongside the child, while others could interpret the teacher&apos;s verbal cues and use their own bodies to draw the child into movement. The platform could calibrate for different levels of parental guidance. But it could not widen the room.</p>
