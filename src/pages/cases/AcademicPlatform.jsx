  ...
  return (
    ...
    >
      ...
      <FadeIn>
        ...
        <p>From an infrastructure studies perspective (Star &amp; Ruhleder, 1996), what I was observing was infrastructure becoming visible through breakdown. The health data ecosystem was not &lsquo;broken&rsquo; in any obvious way — researchers were publishing, datasets were being accessed, the system functioned. But it functioned through workarounds that had become so habitual they were invisible as workarounds. Personal networks substituted for search interfaces. Institutional reputation substituted for metadata. Each workaround was a signal of where the designed system had failed to account for the actual practice of research — and practice theory (Shove, Pantzar &amp; Watson, 2012) would frame these not as individual coping strategies but as reconfigured practices, where the &lsquo;materials&rsquo; (databases, forms, institutional relationships), &lsquo;competences&rsquo; (knowing whom to ask, how to navigate bureaucracy), and &lsquo;meanings&rsquo; (what counts as accessible data) had stabilised into a configuration that served insiders and excluded everyone else.</p>

        <p>I recruited across two levels of seniority on purpose. Junior researchers — five to ten years in — were still navigating the system with fresh frustration. Research leads had learned to work around it. Both perspectives mattered: the one that remembered what broken felt like, and the one that had stopped noticing.</p>
        <p>As a UX researcher trained in industry, I carried assumptions about what &quot;good discovery&quot; meant — I expected interface elegance and feature completeness to be the core problems. The field work unsettled that. My position — as someone trained in product design, not in research governance or public health infrastructure — meant I initially saw this as a design problem. Researchers in the room saw it differently: who decides which datasets are findable? The real friction wasn&apos;t in the interface; it was in the ecosystem&apos;s structure itself. That reframing shaped how the team thought about what a platform could and couldn&apos;t fix. It also raised a question feminist STS scholars have long asked: whose knowledge counts as legitimate, and whose workarounds remain invisible because the people who designed the system never needed them? The recruitment networks, the personal connections, the institutional gatekeeping &mdash; these were not neutral infrastructure. They were mechanisms that determined whose research was possible.</p>
      </FadeIn>
      ...
      <FadeIn>
        ...
        <DiagramImage
          ...
          caption="Insight-to-design translation framework. Every platform feature traces directly to an observed behaviour from contextual inquiry &mdash; the three-column structure served both as an accountability tool and as an epistemic one: where observation alone couldn&apos;t explain what the system needed, the design translation forced those gaps into view."
        />
      ...
      <FadeIn>
        ...
        <p>To translate findings into vision, I built a storyboard: four acts, one researcher. Find. Read metadata. Apply with clarity. Access — without leaving their desk.</p>
        <p>The storyboard did something I hadn&apos;t expected. By walking stakeholders through one researcher&apos;s journey — find, evaluate, wait, access — it made the system&apos;s failures concrete enough to argue about. Building it was itself a form of inquiry: the act of designing the sequence forced me to make invisible assumptions visible, to discover where the platform could actually help and where the real barriers were policy decisions no interface could fix. The artifact generated knowledge that observation alone had not.</p>
        <p>This moment — where a design artifact generates knowledge that precedes and exceeds its function as a deliverable — is what constructive design research scholars call the epistemic role of making (Koskinen et al., 2011). The storyboard was not an illustration of findings. It was a research instrument that forced assumptions into the open: which steps could the platform actually shorten? Which delays were policy decisions masquerading as technical constraints? Which moments of human contact (a librarian&apos;s guidance, a colleague&apos;s recommendation) were not friction to be eliminated but essential infrastructure that a digital platform could not replace? The act of designing the sequence surfaced these questions more precisely than interviews alone had.</p>
      ...
      <FadeIn>
        <h2>Limitations</h2>
        <p>This study engaged 15 participants across multiple research phases — contextual interviews, card-sorting, and secondary validation — a scope appropriate for formative, qualitative work, but not designed for statistical generalisation. Interview participants were recruited through Taiwan&apos;s existing academic networks — a choice that inadvertently reproduced the very exclusion mechanisms I was trying to map. Researchers outside these networks would likely report even more friction; my findings may underestimate the system&apos;s barriers for junior, international, or non-institutional researchers.</p>
        <p>The study focused on five research industries in the sample; future work should validate findings across additional biomedical and clinical domains. The stakeholder ecosystem map captured conditions in 2022; institutional relationships and data infrastructure have shifted considerably since. Additionally, the study prioritised the researcher&apos;s perspective; data management units and platform administrators — whose workflows are equally complex — were not included as primary interview subjects, leaving their needs to be addressed in a subsequent research phase.</p>
        <p>That research taught me something I keep coming back to: when a system makes people wait, makes them guess, makes them depend on who they know — it&apos;s not a usability problem. It&apos;s the system working exactly as it was built. The design question isn&apos;t how to make it smoother. It&apos;s whether the friction is serving anyone, and if not, what it would take to stop. The method that made this visible &mdash; using design artifacts as accountability tools, and building through design what observation alone couldn&apos;t reveal &mdash; transfers to any ecosystem where habituation has made structural barriers invisible.</p>
        <p>There is a rebound effect worth naming. The platform I helped design will make data discovery faster, evaluation clearer, access more transparent. But efficiency gains in research infrastructure do not distribute evenly. Researchers with existing networks, institutional standing, and familiarity with biomedical data conventions will benefit most — precisely because the platform assumes a user who already knows what they are looking for. The risk is that a &lsquo;better&rsquo; interface naturalises the assumption that data access is primarily a usability problem, when the deeper barriers — who gets to define research questions, whose data counts as valuable, which institutions control access — remain structural. Making friction visible is not the same as redistributing power. That distinction matters for how design research positions itself within public infrastructure.</p>
      </FadeIn>
