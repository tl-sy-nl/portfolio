  ...
  return (
    ...
    >
      ...
      <FadeIn>
        ...
        <p>The core question was simple: <em>What are VIP clients already doing — and what does that tell us about what the product should be?</em></p>
        ...
        <p>Standard research formats were ruled out from the start. In-person lab sessions, third-party platforms, and anything that felt clinical or transactional were non-starters for this audience. Drawing on the contextual inquiry tradition (Beyer &amp; Holtzblatt), I adapted the method for a high-privacy context: a <strong>remote contextual inquiry framework</strong> built around a virtual observation room. participants were de-identified and given full privacy assurance, while internal stakeholders — brand managers, sales directors — observed in real time through a one-way mirror arrangement, routing questions through the moderator.</p>
        <p>The trade-off was real: I lost in-person nonverbal cues and environmental detail. But for this audience, the privacy assurance was the condition I couldn&apos;t compromise on. Everything else was negotiable. The setup also served a dual purpose: generating the qualitative depth the project needed, and creating moments where a brand director could hear a VIP client describe, in her own words, exactly what she needed. When that happens, the case for product investment makes itself. The act of designing that observation infrastructure &mdash; deciding what brand directors would see and hear, in what sequence &mdash; functioned as a research method in itself: it reframed the question from &quot;what features do we need?&quot; to &quot;what are clients already doing?&quot; by making stakeholders witnesses to unanticipated behaviour rather than passive recipients of findings.</p>
        <p>I should name my distance from this world. I am not a luxury consumer. I had no prior relationship with high-net-worth clients, no intuition for what a Diamond-tier wardrobe practice feels like from the inside. That distance was, in one sense, methodological: I could see the camera roll behaviour as remarkable precisely because I had no reason to expect it. But it also meant I was interpreting practices I had never lived &mdash; reading significance into habits whose texture I understood only through observation, not experience. The research depended on the distributor&apos;s institutional trust to get me into the room. What I saw there was shaped by that access, and by the limits of what observation alone can reach.</p>
        ...
        <p>I entered with an assumption: that VIP clients would be drawn to the distributor&apos;s brand portfolio and the exclusivity of member-only access. The research surfaced something different.</p>
        ...
        <p>But here&apos;s what I actually found: that behaviour had already migrated to their phones. Clients were photographing every piece in their wardrobe — systematically, one item at a time — because the items were expensive enough that buying a duplicate was a real risk. They organised these into albums and shared them with their SAs over messaging apps. The camera roll had become a working wardrobe archive.</p>
      ...
      <FadeIn>
        ...
        <p>If the wardrobe archive was the product&apos;s centre of gravity, the rest of the architecture needed to orbit around it — not compete with it.</p>
        <h3>Cross-Brand Curation</h3>
        <p>The distributor operates multiple brands, yet VIP clients tend to develop strong loyalty to one label. The camera roll albums were mostly single-brand, but traces of cross-brand pairing did appear — enough to suggest that the appetite existed even if the habit hadn&apos;t fully formed. A core business objective was cross-brand exposure without disrupting the client&apos;s preferred aesthetic relationship. The information architecture surfaced complementary brands through contextual relevance rather than generic browsing, nudging a behaviour that the research showed was latent rather than established.</p>

        <h3>Progressive Disclosure for Membership</h3>
        <p>The membership system is complex: tiered spending thresholds, seasonal milestone events, evolving reward structures. Unlike the wardrobe behaviour, none of this mapped to anything clients were already doing — it was institutional logic, not personal logic. The design surfaced only the most relevant status and upcoming milestone prominently, with full tier detail accessible on demand. The goal was to keep the system from overwhelming the parts of the app that did feel natural.</p>
      </FadeIn>
      ...
      <FadeIn>
        <figure className="case-img case-figure-dark">
          <WardrobeConceptSVG />
          <figcaption>
            The emergent behaviour that became the product&apos;s North Star — a self-built wardrobe archive system that no one had designed but everyone relied on
          </figcaption>
        </figure>
      </FadeIn>
      ...
      <FadeIn>
        ...
        <p>Core flows — registration, brand exploration, and appointment booking — all achieved 100% task completion. Membership-related features landed between 50–83%. The gap was telling: flows that mirrored existing behaviour (browsing, saving, consulting a SA) felt immediately legible, because participants were already doing these things outside the app. Membership tier logic — spending thresholds, milestone events, reward structures — required participants to learn an institutional system that had no equivalent in their daily practice.</p>
        <p>Why? Because wardrobe-related actions mapped onto something clients already did: photographing outfits, checking what they owned, asking their SA for advice. The app merely gave those habits a dedicated surface. Tier logic, by contrast, asked clients to care about a system the distributor had built for its own operational needs — tracking spend, segmenting service levels, triggering milestone rewards. None of that reflected how clients thought about their own relationship with fashion. The wardrobe felt like theirs. The tier system felt like something the company had designed for its own purposes.</p>
        <p>That distinction confirmed the North Star: design for what people already do, and keep institutional logic from crowding it out.</p>
        <p>By the end of testing, users were reaching for words along the lines of <em>clear</em>, <em>efficient</em>, and <em>easy to navigate</em> — paraphrased from session notes, not direct quotes. For a product serving an audience that expects simplicity as a baseline, that was the right signal.</p>
        ...
        <p>I&apos;d assumed users needed what I&apos;d designed. Fieldwork proved otherwise. With nothing but a phone camera and album, these clients had already built their own curation system — outfits worn, organized by season, shared with their SA. It worked. No one designed it. No one asked for it.</p>
        ...
        <p>Lucy Suchman&apos;s concept of situated action (1987) offers a way to understand what I observed. Suchman argued that plans — including designed systems — are not what organise behaviour; they are resources that people draw on, adapt, and abandon in the course of action. The camera roll wardrobe was precisely this kind of situated practice: not a planned system, but an improvisation that emerged from the gap between what clients needed and what designed systems offered. The VIP clients were not following a workflow. They were making do — and in making do, they had produced something more honest than anything a design brief could have specified.</p>
        <p>That instinct — start by observing what people have already made, and take it seriously as evidence of what they actually need — has become my primary research method. Infrastructure scholars have argued that designed systems become visible only when they break down (Star &amp; Ruhleder, 1996). The camera roll wardrobe is the inverse: when no formal system exists, people&apos;s improvised practices make the need visible. For my PhD, I want to apply that same lens to public space — observing the paths children improvise as a form of spatial knowledge (Ingold, 2007), and asking what those paths reveal about infrastructure that was designed without them in mind.</p>

        <h2>Limitations</h2>
        <p>I sampled across Silver, Gold, and Diamond tier clients to cover the distributor&apos;s membership spectrum. In practice, the deepest behavioural insights came from Gold and Diamond participants — they had the longest SA relationships and the most established routines to observe. That was partly a research design choice and partly a reflection of who was willing to share. But it means the camera roll insight came from the clients with the most institutional attention, the most SA relationships, the most familiarity with luxury retail.</p>
        <p>This research was only possible because the distributor already had these relationships. Clients participated because they trusted the brand, not because they trusted research. I had access because of institutional standing, not because I earned it in the room. I studied the clients the distributor most wanted to keep. I did not study the ones they had already lost, or never reached.</p>
        <p>Silver-tier members — lower spend, often newer to the distributor — might have entirely different workarounds, different needs, different frustrations I never heard. The product I designed optimised for clients the distributor already valued most. Whether it serves the ones they haven&apos;t reached is a question the research can&apos;t answer.</p>
        <p>The privacy constraints of this context — de-identification, virtual observation, limited session flexibility — also shaped what I could see. I observed behaviour through screens. I didn&apos;t sit in anyone&apos;s closet. Some things about how people relate to their wardrobes, physically, spatially, emotionally, are only visible in person.</p>
