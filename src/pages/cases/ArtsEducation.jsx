  ...
  return (
    ...
    >
      ...
      <FadeIn>
        ...
        <p>But I could not unsee something else — something the research surfaced but could not resolve within its scope. What a four-year-old could practise at home depended on a chain of material conditions that started well before the platform: the apartment&apos;s square footage, the parent&apos;s work schedule, the parent&apos;s confidence in guiding movement with their own body. In concept testing, we found that parents&apos; guidance capacity varied enormously — some could only sit and watch the screen alongside the child, while others could translate the teacher&apos;s cues into their own bodily interaction, drawing the child into movement through physical presence alone. The platform could calibrate for different levels of parental guidance. But it could not widen the room.</p>
        <p>That is the distinction that stayed with me. In the home, some constraints on a child&apos;s practice were negotiable — a parent could learn new guidance techniques, a schedule could shift, a table could be pushed aside. But the room itself was not. Thirty square metres, someone else&apos;s ceiling below — that was an architectural decision made years earlier, by someone who had never imagined a child&apos;s movement practice in that space. The constraint was invisible as a constraint. It was simply what the apartment &quot;was.&quot;</p>
