  ...
  return (
    ...
    >
      ...
      <FadeIn>
        ...
        <p>That instinct — start by observing what people have already made, and take it seriously as evidence of what they actually need — has become my primary research method. Infrastructure scholars have argued that designed systems become visible only when they break down (Star &amp; Ruhleder, 1996). The camera roll wardrobe is the inverse: when no formal system exists, people&apos;s improvised practices make the need visible. This pattern &mdash; the emergent artifact as a form of design knowledge &mdash; is methodologically transferable: it surfaces what designed systems missed by revealing the tacit logic people embed in their own workarounds. For my PhD, I want to apply that same lens to public space — observing the paths children improvise as a form of spatial knowledge (Ingold, 2007), and asking what those paths reveal about infrastructure that was designed without them in mind.</p>
