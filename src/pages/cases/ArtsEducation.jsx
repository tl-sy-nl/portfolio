  ...
  return (
    ...
    >
      ...
      <FadeIn>
        ...
        <p>The research pulled in two directions at once. Families with young children — some as young as three, most between four and six — needed proof that discipline could survive at home, that a parent&apos;s mediation wouldn&apos;t dilute the practice into play. Senior practitioners (長青者), a segment the organisation had cultivated for years, needed something quieter: whether their aging bodies could still find home in the practice without a teacher watching. These weren&apos;t different user segments. They were different relationships to presence, embodiment, and what a space makes possible.</p>
        ...
        <p>That decision to enter people&apos;s actual environments turned out to matter — especially for the families with young children. In northern Taiwan&apos;s apartments, a living room is thirty square metres shared with family meals and homework and sleep. A four-year-old practising movement here cannot jump; the floor beneath is someone else&apos;s ceiling. In Taichung and Kaohsiung, families had play rooms — walls covered in crayon drawings, foam mats on the floor, space where a child&apos;s body could actually move. A child&apos;s movement practice, it became clear, is not a property of the child. It is a property of the room.</p>
      ...
      <FadeIn>
        ...
        <p>The parent segment surprised us in a different direction. We had gone in assuming parents were facilitators — adults who would set up the device, press play, and step back. At home, with no teacher present, that assumption dissolved. The parent becomes the pedagogical environment.</p>
      ...
      <FadeIn>
        ...
        <p>This realisation — that a child&apos;s agency is not a property of the child but a property of the space they inhabit — I could not unsee it once I had. In northern Taiwan&apos;s apartments, the room literally bounded what a four-year-old could practise. A small living room didn&apos;t just constrain the child&apos;s movement; it turned the practice into a different kind of practice. The same child with the same body in a different room would have learned something different.</p>
        <p>For my PhD, I am investigating the same mechanism in public infrastructure: sidewalks too narrow for a child to ride a bicycle, playgrounds fenced for liability, parks designed for passive sitting. Not &quot;what children can do&quot; as if that were a universal fact about childhood development. But what children are designed to do — by whom, in what materials, and at what cost to their own sense of what is possible.</p>
      </FadeIn>
      ...
      <FadeIn>
        ...
        <p>Both segments — families with young children, and senior practitioners — were existing students or parents of existing students; the platform we designed was built for believers. We did not study families who considered the practice and walked away, or senior practitioners who had quietly stopped attending. Their reasons might have told a different story about what the practice actually demands and who it serves. What we heard was shaped by who was still in the room. Per NDA, the organisation&apos;s identity and specific platform metrics have not been disclosed.</p>
      </FadeIn>
